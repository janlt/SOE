...
#ifndef SOE_SOE_SOE_RCSDBEM_SRC_RCSDBSPACE_HPP_
#define SOE_SOE_SOE_RCSDBEM_SRC_RCSDBSPACE_HPP_
...
private:
    std::vector<RcsdbLocalFacade::Store *>  stores;
...
#endif /* SOE_SOE_SOE_RCSDBEM_SRC_RCSDBSPACE_HPP_ */
