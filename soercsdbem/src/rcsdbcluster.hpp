...
#ifndef SOE_SOE_SOE_RCSDBEM_SRC_RCSDBCLUSTER_HPP_
#define SOE_SOE_SOE_RCSDBEM_SRC_RCSDBCLUSTER_HPP_
...
private:
    std::vector<RcsdbLocalFacade::Space *>  spaces;
    ...
    static std::list<RcsdbFacade::NameBase *>                   archive;
...
public:
    virtual ~Cluster();
    virtual void SetParent(RcsdbFacade::NameBase *par) { parent = this; }
...
protected:
    ...
    static void ArchiveName(RcsdbFacade::NameBase *name);
    ...
    bool DeleteStore(RcsdbLocalFacade::Store *st);
    ...
    static void DeleteFromStores(RcsdbLocalFacade::Store *st);
...
#endif /* SOE_SOE_SOE_RCSDBEM_SRC_RCSDBCLUSTER_HPP_ */
