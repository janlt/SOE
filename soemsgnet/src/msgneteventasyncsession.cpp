/**
 * @file    msgneteventasyncsession.cpp
...
EventAsyncSession::EventAsyncSession(Point &_point, bool _test_mode) throw(std::runtime_error)
    :EventSession<IoEvent>(_point, _test_mode)
{}

EventAsyncSession::~EventAsyncSession()
{}

int EventAsyncSession::Start()
{
    return 0;
}
