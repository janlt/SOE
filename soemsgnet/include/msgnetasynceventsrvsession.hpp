/**
 * @file    msgnetasynceventsrvsession.hpp
...
/*
 * msgnetasynceventsrvsession.hpp
 *
 *  Created on: Mar 14, 2017
 *      Author: Jan Lisowiec
 */

#ifndef SOE_SOE_SOE_MSGNET_INCLUDE_MSGNETASYNCEVENTSRVSESSION_HPP_
#define SOE_SOE_SOE_MSGNET_INCLUDE_MSGNETASYNCEVENTSRVSESSION_HPP_

namespace MetaNet {

class EventSrvAsyncSession: public EventSrvSession<IoEvent>
{
    bool in_finito;
    bool out_finito;

public:
    EventSrvAsyncSession(Point &_point, bool _test_mode = false) throw(std::runtime_error);
    virtual ~EventSrvAsyncSession();
...
#endif /* SOE_SOE_SOE_MSGNET_INCLUDE_MSGNETASYNCEVENTSRVSESSION_HPP_ */
